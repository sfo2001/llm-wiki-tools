...
The source pattern document lives in `docs/karpathy-llm-wiki.md`; design rationale is recorded as ADRs in `docs/adr/`. (The original implementation plans are preserved in git history.)
